...
AVATAR_PROMPT = (
    f"Реалистичная крупная фотография на футбольную тему для аватарки Telegram-канала, "
    ...
    f"Настоящее фото, снятое на камеру, НЕ рисунок, НЕ иллюстрация, НЕ мультфильм, "
    f"НЕ логотип, НЕ эмблема. Без текста и надписей, крупный план, хорошо читается "
    f"в маленьком круглом кадре."
)

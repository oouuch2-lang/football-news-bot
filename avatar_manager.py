...
AVATAR_PROMPT = (
    f"Эмблема спортивного Telegram-канала про футбол, квадратная иконка, "
    f"стиль: {brand_config.IMAGE_STYLE}. "
    f"Основной цвет: {brand_config.PRIMARY_COLOR}, фон: {brand_config.BACKGROUND_COLOR}. "
    f"Без текста и надписей, минимализм, подходит для маленькой круглой аватарки."
)

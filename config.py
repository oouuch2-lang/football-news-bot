...
HUGGINGFACE_MODEL = os.environ.get("HUGGINGFACE_MODEL", "stabilityai/stable-diffusion-xl-base-1.0")

CLOUDFLARE_ACCOUNT_ID = os.environ.get("CLOUDFLARE_ACCOUNT_ID", "")
CLOUDFLARE_API_TOKEN = os.environ.get("CLOUDFLARE_API_TOKEN", "")
CLOUDFLARE_MODEL = os.environ.get("CLOUDFLARE_MODEL", "@cf/black-forest-labs/flux-1-schnell")

# --- Файл с историей опубликованных новостей (чтобы не постить одну новость дважды) ---
HISTORY_FILE = os.environ.get("HISTORY_FILE", "data/published_history.json")
